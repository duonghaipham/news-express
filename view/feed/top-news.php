...
<div id="content">
    <div id="top-news">
        <?php
        echo "<a href='http://localhost/news-express/index.php?action=view_&id_feed=" . $head_news[0]['ID_FEED'] . "'>";
    ...
    <div id="runner-up-news">
        ...
        for ($i = 1; $i < sizeof($head_news); $i++) {
            echo "<a class='runner-up-item' href='http://localhost/news-express/index.php?action=view_&id_feed=" . $head_news[$i]['ID_FEED'] . "'>";
